...
void test_modulus(void)
{
     ...
     */
     ...
     valuee.num_2=3;
     modulus(valuee,&ans);
     TEST_ASSERT_EQUAL(2,ans.final_answer);
     ...
     valuee.num_2=7;
     logg(valuee,&ans);
     TEST_ASSERT_EQUAL(6,ans.final_answer);
...
void test_factorial(void)
{
    ...
    valuee.num_1=13;
    sqrtt(valuee,&ans);
    TEST_ASSERT_EQUAL(6227020800,ans.final_answer);
    /**
    ...
    valuee.num_1=6;
    sqrtt(valuee,&ans);
    TEST_ASSERT_EQUAL(720,ans.final_answer);
}
